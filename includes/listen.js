module.exports = function({ api }) {
  ...
  const v = pkg.version;
  axios.get('https://raw.githubusercontent.com/KHAIVO009/botpkv2/main/package.json')
    .then(response => {
      const gitVersion = response.data.version;

      if (compareVersions(gitVersion, v) > 0) {
        global.loading.log(`Version ${co(gitVersion)} is available! Consider checking out '${cb('https://github.com/KHAIVO009/botpkv2')}' for the latest updates.`, 'UPDATE');
      } else {
